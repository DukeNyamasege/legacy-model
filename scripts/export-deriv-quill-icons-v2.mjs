...
const selected = {
  ...
  demoAccount: svgMarkup(choose("Deriv Demo account", [Accounts, Legacy], ["AccountsDemoIcon", "AccountDemoIcon", "LegacyAccountDemoIcon", "LegacyDemoAccountIcon", "AccountsVirtualIcon", "AccountVirtualIcon"], [["account", "demo"], ["demo", "account"], ["account", "virtual"], ["virtual", "account"]]), "Deriv Demo account"),
  realAccount: svgMarkup(choose("Deriv Real account", [Accounts, Legacy], ["AccountsRealIcon", "AccountRealIcon", "LegacyAccountRealIcon", "LegacyRealAccountIcon"], [["account", "real"], ["real", "account"]]), "Deriv Real account"),
...
await writeFile(resolve(output, "deriv-quill-icons-v2.json"), `${JSON.stringify({ package: "@deriv/quill-icons", version: "2.4.18", repository: "deriv-com/quill-icons", source: "official-build-time-static-svg", exports: provenance }, null, 2)}\n`, "utf8");
