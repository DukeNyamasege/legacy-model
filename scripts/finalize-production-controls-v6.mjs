...
// ---------------------------------------------------------------------------
// 2. Browser-direct Split recovery: exact quoted profit share for N successes.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 4. Canonical transaction table: exact time + market + exit digit only.
// ---------------------------------------------------------------------------
...
console.log("Production v6 finalized: premium fail-open, hard Stop support, exact quoted Split recovery, stable Run UI and exit-digit transaction metadata");
