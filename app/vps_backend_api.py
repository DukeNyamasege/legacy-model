...
preferences, the persistent Action 5 scheduler, and the Action 6A premium-access
gate wrap the final routes/lifespan. Neither scheduler nor premium access replaces
the financial execution worker.
"""
...
# passes through one subscription authority. Safe account/stop/setup mutations are
# explicitly exempted inside the gate.
