...
Text-to-Strategy compiler, and account-wide automation preferences are installed
last so they see the final OAuth/lifecycle routes without touching the trading
worker runtime.
"""
