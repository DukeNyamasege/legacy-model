...
observability, Telegram control, constant-time dashboard session reads, and the
Text-to-Strategy compiler are installed last so they see the final OAuth/lifecycle
routes without touching the trading worker runtime.
"""
