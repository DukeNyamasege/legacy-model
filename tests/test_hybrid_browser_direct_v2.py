...
class HybridBrowserDirectV2Contract(unittest.TestCase):
    ...
    def test_frontend_build_ships_production_v6_single_authority(self) -> None:
        ...
        self.assertIn("/direct-transaction-ledger-v6.js?v=20260818-direct-ledger-v7", dockerfile)
        ...
        self.assertIn("/run-panel-usability-v1.js?v=20260818-run-panel-usability-v1", dockerfile)
