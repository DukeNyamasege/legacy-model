(() => {
  ...
  window.FOA_STRATEGY_EDIT_AUTHORITY_VERSION = "20260814-template-runtime-loader-v4";
  ...
  loadScript("/builder-edit-stability.js?v=20260814-1", "foa-builder-edit-stability-js");
})();
